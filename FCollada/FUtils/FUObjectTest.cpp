...
TESTSUITE_TEST(4, ContainedObjectPointer)
	// Create a couple of objects and have multiple containers tracking them.
...
TESTSUITE_TEST(5, ObjectReference)
...
TESTSUITE_TEST(6, ObjectContainerErase)
	// Create a couple of objects and have multiple containers tracking them.
