...
public:
	...
	/** Sets a new object to reference.
		...
		@param __ptr The new object to reference.
		@return This reference. */
...
public:
	...
	inline const_iterator find(const ObjectClass* item) const { const_iterator f = Parent::find(item); return begin() + (f - begin()); } /**< See above. */
