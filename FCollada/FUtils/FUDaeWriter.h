...
namespace FUDaeWriter
{
	...
	/** Writes out a COLLADA array of matrices.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddArray(xmlNode* parent, const char* id, const FMMatrix44List& values);
	...
	/** Writes out a COLLADA array of 3D vectors.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddArray(xmlNode* parent, const char* id, const FMVector3List& values);
	...
	/** Writes out a COLLADA array of 2D vectors.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddArray(xmlNode* parent, const char* id, const FMVector2List& values);
	...
	/** Writes out a COLLADA array of floating-point values.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddArray(xmlNode* parent, const char* id, const FloatList& values);
	...
	/** Writes out a COLLADA multi-dimensional source of floating-point values.
		...
		@param parameters The list of accessor parameter names.
			Some valid parameter names are available in the FUDaeAccessor class.
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddSourceFloat(xmlNode* parent, const char* id, const FloatList& values, size_t stride=1, const char** parameters=NULL);
	...
	/** Writes out a COLLADA source of floating-point values.
		...
		@param parameter The accessor parameter name.
			Some valid parameter names are available in the FUDaeAccessor class.
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddSourceFloat(xmlNode* parent, const char* id, const FloatList& values, const char* parameter=NULL);
	...
	/** Writes out a COLLADA source of matrices.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddSourceMatrix(xmlNode* parent, const char* id, const FMMatrix44List& values);
	...
	/** Writes out a COLLADA source of 2D positions or vectors.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddSourcePosition(xmlNode* parent, const char* id, const FMVector2List& values);
	...
	/** Writes out a COLLADA source of 3D positions or vectors.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddSourcePosition(xmlNode* parent, const char* id, const FMVector3List& values);
	...
	/** Writes out a COLLADA source of 4D positions or vectors.
		...
		@return The created XML tree node. */
	FCOLLADA_EXPORT xmlNode* AddSourcePosition(xmlNode* parent, const char* id, const FMVector4List& values);
