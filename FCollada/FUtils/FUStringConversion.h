...
public:
	...
	static void ToString(FUSStringBuilder& builder, const FloatList& values);
	...
	static const fm::string& ToString(const FMVector4& p);
	static const fstring& ToFString(const FMVector4& p); /**< See above. */

	/** Converts a matrix into a string.
		@param value The matrix to convert.
		@return The string containing the converted matrix. */
	static const fm::string& ToString(const FMMatrix44& value);
	static const fstring& ToFString(const FMMatrix44& value); /**< See above. */

	/** Converts a 2D vector into a string.
		@param value The 2D vector to convert.
		@return The string containing the converted vector. */
	static const fm::string& ToString(const FMVector2& value);
	static const fstring& ToFString(const FMVector2& value); /**< See above. */

	/** Converts a 3D vector into a string.
		@param value The 3D vector to convert.
		@return The string containing the converted vector. */
	static const fm::string& ToString(const FMVector3& value);
	static const fstring& ToFString(const FMVector3& value); /**< See above. */
	...
	/** Converts a matrix into a string.
		...
		@param value The matrix to convert. */
	static void ToString(FUSStringBuilder& builder, const FMMatrix44& value);
	static void ToFString(FUStringBuilder& builder, const FMMatrix44& value); /**< See above. */

	/** Converts a 2D vector into a string.
		@param builder The string builder that will contain the 2D vector.
			This string builder is not cleared of its contents.
		@param value The 2D vector to convert. */
	static void ToString(FUSStringBuilder& builder, const FMVector2& value);
	static void ToFString(FUStringBuilder& builder, const FMVector2& value); /**< See above. */

	/** Converts a 3D vector into a string.
		@param builder The string builder that will contain the 3D vector.
			This string builder is not cleared of its contents.
		@param value The 3D vector to convert. */
	static void ToString(FUSStringBuilder& builder, const FMVector3& value);
	static void ToFString(FUStringBuilder& builder, const FMVector3& value); /**< See above. */

	/** Converts a 4D vector into a string.
		@param builder The string builder that will contain the 4D vector.
			This string builder is not cleared of its contents.
		@param p The 4D vector to convert. */
	static void ToString(FUSStringBuilder& builder, const FMVector4& p);
	static void ToFString(FUStringBuilder& builder, const FMVector4& p); /**< See above. */
};
