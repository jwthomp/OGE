...
public:
	...
	inline FCDMaterialInstance** GetMaterialInstances() { return materials.begin(); }
	inline const FCDMaterialInstance** GetMaterialInstances() const { return materials.begin(); } /**< See above. */
	...
	/** [INTERNAL] Reads in the geometry instance information from the XML node tree.
		@param instanceNode The XML tree node that contains the geometry instance information.
		@return Whether the geometry instance was parsed successfully. */
	virtual bool LoadFromXML(xmlNode* instanceNode);

	/** [INTERNAL] Writes out the geometry instance information to the XML node tree.
		@param parentNode The XML tree node into which to insert the geometry instance information.
		@return The newly created XML tree node. */
