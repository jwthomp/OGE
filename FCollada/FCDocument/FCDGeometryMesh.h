...
private:
	...
	FCDGeometry* parent;
	FUObjectContainer<FCDGeometrySource> sources;
	FUObjectContainer<FCDGeometryPolygons> polygons;

	FUObjectList<FCDGeometrySource> vertexSources;
...
public:
	...
	inline FCDGeometrySource** GetVertexSources() { return vertexSources.begin(); }
	inline const FCDGeometrySource** GetVertexSources() const { return vertexSources.begin(); } /**< See above. */
	...
	inline FCDGeometrySource** GetSources() { return sources.begin(); }
	inline const FCDGeometrySource** GetSources() const { return sources.begin(); } /**< See above. */
