...
public:
	...
	inline float* GetData() { return sourceData.begin(); }
	inline const float* GetData() const { return sourceData.begin(); } /**< See above. */
	...
	inline float* GetValue(size_t index) { FUAssert(index < GetValueCount(), return NULL); return &sourceData.at(index * stride); }
