...
public:
	...
	*/
	...
	/** [INTERNAL] Reads in the analytical geometry from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics scene. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the analytical geometry to the given COLLADA XML 
		tree node.
...
public:
	...
	/** [INTERNAL] Reads in the box from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics box. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<box\> element to the given COLLADA XML tree
		node.
		@param parentNode The COLLADA XML parent node in which to insert the 
			physics model.
		@return The created element XML tree node. */
...
public:
	...
	*/
	...
	/** [INTERNAL] Reads in the plane from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics plane. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<plane\> element to the given COLLADA XML 
		tree node.
		@param parentNode The COLLADA XML parent node in which to insert the 
			physics model.
		@return The created element XML tree node. */
...
public:
	...
	*/
	...
	/** [INTERNAL] Reads in the sphere from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics sphere. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<sphere\> element to the given COLLADA XML 
		tree node.
		@param parentNode The COLLADA XML parent node in which to insert the 
			physics model.
		@return The created element XML tree node. */
...
public:
	...
	/** [INTERNAL] Reads in the cylinder from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics cylinder. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<cylinder\> element to the given COLLADA XML
		tree node.
		@param parentNode The COLLADA XML parent node in which to insert the 
			physics model.
		@return The created element XML tree node. */
...
public:
	...
	/** [INTERNAL] Reads in the capsule from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics capsule. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<capsule\> element to the given 
...
public:
	...
	/** [INTERNAL] Reads in the tapered capsule from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics tapered capsule. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<tapered_capsule\> element to the given 
		COLLADA XML tree node.
		@param parentNode The COLLADA XML parent node in which to insert the 
			physics model.
		@return The created element XML tree node. */
...
public:
	...
	float radius2; /**< The second radius of the capsule. */
};
...
public:
	...
	/** [INTERNAL] Reads in the tapered cylinder from a XML tree node.
		@param node The XML tree node.
		@return The status of the import. If the status is 'false', it may be 
			dangerous to use the physics tapered cylinder. */
	virtual bool LoadFromXML(xmlNode* node);

	/** [INTERNAL] Writes out the \<tapered_cylinder\> element to the given 
		COLLADA XML tree node.
		@param parentNode The COLLADA XML parent node in which to insert the 
			physics model.
		@return The created element XML tree node. */
...
public:
	...
	float radius2; /**< The second radius of the cylinder. */
};
