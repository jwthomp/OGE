...
public:
	...
	*/
	...
	/** [INTERNAL] Reads in the physics scene components from a XML tree node.
		@param sceneNode The XML tree node.
	...
	/** [INTERNAL] Writes out the \<physics_scene\> element to the given 
