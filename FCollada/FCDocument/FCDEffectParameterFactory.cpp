...
FCDEffectParameter* FCDEffectParameterFactory::LoadFromXML(FCDocument* document, xmlNode* parameterNode, bool* status)
{
	...
	if (parameter != NULL)
	{
		bool s = parameter->LoadFromXML(parameterNode);
