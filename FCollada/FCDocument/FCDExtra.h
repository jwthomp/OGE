...
public:
	...
	inline FCDETechniqueContainer& GetTechniques() { return techniques; }
	inline const FCDETechniqueContainer& GetTechniques() const { return techniques; } /**< See above. */
...
public:
	...
	inline FCDENode* AddChildNode(const fm::string& name) { FCDENode* node = children.Add(GetDocument(), this); node->SetName(name.c_str()); SetDirtyFlag(); return node; } /**< See above. */
...
private:
	...
	FCDEType* parent;
	FUObjectPtr<FUObject> pluginOverride;
	fm::string profile;
...
public:
	...
	FUObjectPtr<FUObject> GetPluginObject() { return pluginOverride; }
	const FUObjectPtr<FUObject> GetPluginObject() const { return pluginOverride; } /**< See above. */

	/** Sets the plug-in object that overrides the extra tree for this profile.*/
	void SetPluginObject(FUObjectPtr<FUObject> plugin){ pluginOverride = plugin; }
