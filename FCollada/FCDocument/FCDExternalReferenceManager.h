...
/**
	...
	It keeps track of all the document's external references and the FCollada
	documents that they reference, whether they are loaded or not.
...
private:
	...
	FUObjectContainer<FCDExternalReference> references;
...
public:
	...
	/** Adds a new external reference to this document.
		@param instance The entity instance that references an external entity. */
