...
private:
	...
	// Whether this node is a joint/bone.
	bool isJoint;
	fm::string daeSubId;
...
public:
	...
	inline FCDSceneNode** GetParents() { return parents.begin(); }
	inline const FCDSceneNode** GetParents() const { return parents.begin(); } /**< See above. */
	...
	inline const FCDEntity* FindSubId(const fm::string& subId) const { return const_cast<const FCDEntity*>(const_cast<FCDSceneNode*>(this)->FindSubId(subId)); } /**< See above. */
	...
	/** [INTERNAL] Recursively writes this node, and all children to xml.
...
private:
	bool LoadFromExtra();
	void WriteVisualSceneToXML(xmlNode* node) const;
