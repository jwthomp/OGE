...
public:
	/** Constructor.
		@param document The FCollada document that owns the external reference.
		@param instance The entity instance that contains the external reference. */
	...
	/** Retrieves the full URI of the external reference.
		...
		@param relative Whether to generate a URI relative to the current FCollada document.
