...
private:
	...
	fm::pvector<FCDEffectParameterAnnotation> annotations;
...
public:
	...
	inline bool IsGenerator() const { return isGenerator; }

	/** Sets this effect parameter as a generator. */
	inline void SetGenerator() { isGenerator = true; SetDirtyFlag(); }

	/** Retrieves whether this effect parameter is a parameter modifier.
		A ColladaFX parameter must be generated to be modified or bound at
		higher abstraction levels.
		@return Whether this is a modifier. */
	inline bool IsModifier() const { return !isGenerator; }

	/** Sets this effect parameter as a modified. */
	inline void SetModifier() { isGenerator = false; SetDirtyFlag(); }

	/**	Retrieves the list of annotations for this parameter.
		@return The list of annotations. */
	inline FCDEffectParameterAnnotation** GetAnnotations() { return annotations.begin(); }
	...
	template <class T> inline void AddAnnotation(const fchar* name, FCDEffectParameter::Type type, const T& value) { globalBuilder.set(value); AddAnnotation(name, type, globalBuilder.ToCharPtr()); } /**< See above. */
	template <class T> inline void AddAnnotation(const fstring& name, FCDEffectParameter::Type type, const T& value) { globalBuilder.set(value); AddAnnotation(name.c_str(), type, globalBuilder.ToCharPtr()); } /**< See above. */

	/** Releases an annotation of this parameter.
		@param annotation The annotation to release. */
	inline void ReleaseAnnotation(FCDEffectParameterAnnotation* annotation) { annotations.release(annotation); SetDirtyFlag(); }
...
public:
	...
	const FMVector4& GetValue() const { return value; } /**< See above.*/

	/** Sets the vector value.
		@param _value The 4D vector value for the effect parameter. */
