...
namespace FCDAnimationCurveTools
{
	...
	FCOLLADA_EXPORT FCDAnimationMultiCurve* MergeCurves(const FCDAnimationCurveConstList& toMerge, const FloatList& defaultValues, const StringList& defaultQualifiers = StringList());
	inline FCDAnimationMultiCurve* MergeCurves(const FCDAnimationCurveList& toMerge, const FloatList& defaultValues, const StringList& defaultQualifiers = StringList()) { return MergeCurves(*(const FCDAnimationCurveConstList*) &toMerge, defaultValues, defaultQualifiers); } /**< See above. */
