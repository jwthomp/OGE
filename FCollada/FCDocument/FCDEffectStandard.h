...
public:
	...
	const FCDTextureContainer& GetTextureBucket(uint32 bucket) const; /**< See above. */
	...
	inline const FMVector4& GetTranslucencyColor() const { return translucencyColor; } /**< See above. */
