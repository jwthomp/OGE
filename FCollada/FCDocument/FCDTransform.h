...
public:
	...
	/** Sets on a scene node parent, the transform dirty flag. */
...
public:
	...
	inline void SetTranslation(const FMVector3& _translation) { translation = _translation; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Sets the translation 3D displacement vector.
		@param x The x-component displacement.
		@param y The y-component displacement.
		@param z The z-component displacement. */
	inline void SetTranslation(float x, float y, float z) { translation = FMVector3(x, y, z); SetTransformsDirtyFlag(); SetDirtyFlag(); }
...
public:
	...
	inline void SetScale(const FMVector3& _scale) { scale = _scale; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Sets the factors of the non-uniform scale.
		@param x The x-component scale factor.
		@param y The y-component scale factor.
		@param z The z-component scale factor. */
	inline void SetScale(float x, float y, float z) { scale = FMVector3(x, y, z); SetTransformsDirtyFlag(); SetDirtyFlag(); }
...
public:
	...
	inline void SetAxis(const FMVector3& _axis) { axis = _axis; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Sets the rotation axis.
		@param x The x-component of the rotation axis.
		@param y The y-component of the rotation axis.
		@param z The z-component of the rotation axis. */
	inline void SetAxis(float x, float y, float z) { axis = FMVector3(x, y, z); SetTransformsDirtyFlag(); SetDirtyFlag(); }
	...
	inline void SetAngle(float a) { angle = a; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Sets the rotation components
		@param _axis The rotation axis.
		@param a The rotation angle, in degrees. */
	inline void SetRotation(const FMVector3& _axis, float a) { axis = _axis; angle = a; SetTransformsDirtyFlag(); SetDirtyFlag(); }
	...
	inline void SetOrientation(const FMQuaternion& q) { q.ToAngleAxis(axis, angle); angle = FMath::RadToDeg(angle); SetTransformsDirtyFlag(); SetDirtyFlag(); }
...
public:
	...
	inline void SetTransform(const FMMatrix44& mx) { transform = mx; SetTransformsDirtyFlag(); SetDirtyFlag(); }
...
public:
	...
	inline void SetPosition(const FMVector3& pos) { position = pos; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Sets the viewer's position.
		@param x The x-component of the position.
		@param y The y-component of the position.
		@param z The z-component of the position. */
	inline void SetPosition(float x, float y, float z) { position = FMVector3(x, y, z); SetTransformsDirtyFlag(); SetDirtyFlag(); }
	...
	inline void SetTarget(const FMVector3& _target) { target = _target; SetTransformsDirtyFlag(); SetDirtyFlag(); }
	...
	inline void SetTarget(float x, float y, float z) { target = FMVector3(x, y, z); SetTransformsDirtyFlag(); SetDirtyFlag(); }
	...
	inline void SetUp(const FMVector3& _up) { up = _up; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Sets the viewer's up-vector.
		@param x The x-component of the up-vector.
		@param y The y-component of the up-vector.
		@param z The z-component of the up-vector. */
	inline void SetUp(float x, float y, float z) { up = FMVector3(x, y, z); SetTransformsDirtyFlag(); SetDirtyFlag(); }
...
public:
	...
	FMVector3& GetRotateAxis() { return rotateAxis; } /**< See above. */

	/** Sets the axis which is rotated.
		@param axis The rotated axis. */
	inline void SetRotateAxis(const FMVector3& axis) { rotateAxis = axis; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Retrieves the axis around which the rotation is done.
		@return The rotation axis. */
	const FMVector3& GetAroundAxis() const { return aroundAxis; }
	FMVector3& GetAroundAxis() { return aroundAxis; } /**< See above. */

	/** Sets the axis around which the rotation is done.
		@param axis The rotation axis. */
	inline void SetAroundAxis(const FMVector3& axis) { aroundAxis = axis; SetTransformsDirtyFlag(); SetDirtyFlag(); }

	/** Retrieves the rotation angle.
		@return The rotation angle. */
	const float& GetAngle() const { return angle; }
	float& GetAngle() { return angle; } /**< See above. */

	/** Sets the rotation angle.
		@param _angle The rotation angle. */
	inline void SetAngle(float _angle) { angle = _angle; SetTransformsDirtyFlag(); SetDirtyFlag(); }
