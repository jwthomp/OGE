...
public:
	...
	/** Retrieves the base target geometry for this controller.
		...
		@return The base target geometry. This pointer will be NULL
			...
			is not a geometry. */
	FCDGeometry* GetBaseGeometry() { return const_cast<FCDGeometry*>(const_cast<const FCDController*>(this)->GetBaseGeometry()); }
	...
	/** Retrieves the lowest controller on this stack.
		...
		@return The base controller. This pointer will be NULL
			if no base target is defined or if the base target entity
			is not a geometry. */
	FCDController* GetBaseGeometryController() 	{ return const_cast<FCDController*>(const_cast<const FCDController*>(this)->GetBaseGeometryController()); }
